...
TYPES = defaultdict(lambda: '?', {
    ...
    808: ['Meltan','steel','none'],
    809: ['Melmetal','steel','none'],
    810: ['Grookey','grass','none'],
    811: ['Thwackey','grass','none'],
    812: ['Rillaboom','grass','none'],
    813: ['Scorbunny','fire','none'],
    814: ['Raboot','fire','none'],
    815: ['Cinderace','fire','none'],
    816: ['Sobble','water','none'],
    817: ['Drizzile','water','none'],
    818: ['Inteleon','water','none'],
    819: ['Skwovet','normal','none'],
    820: ['Greedent','normal','none'],
    821: ['Rookidee','flying','none'],
    822: ['Corvisquire','flying','none'],
    823: ['Corviknight','flying','steel'],
    824: ['Blipbug','bug','none'],
    825: ['Dottler','bug','psychic'],
    826: ['Orbeetle','bug','psychic'],
    827: ['Nickit','dark','none'],
    828: ['Thievul','dark','none'],
    829: ['Gossifleur','grass','none'],
    830: ['Eldegoss','grass','none'],
    831: ['Wooloo','normal','none'],
    832: ['Dubwool','normal','none'],
    833: ['Chewtle','water','none'],
    834: ['Drednaw','water','rock'],
    835: ['Yamper','electric','none'],
    836: ['Boltund','electric','none'],
    837: ['Rolycoly','rock','none'],
    838: ['Carkol','rock','fire'],
    839: ['Coalossal','rock','fire'],
    840: ['Applin','grass','dragon'],
    841: ['Flapple','grass','dragon'],
    842: ['Appletun','grass','dragon'],
    843: ['Silicobra','ground','none'],
    844: ['Sandaconda','ground','none'],
    845: ['Cramorant','flying','water'],
    846: ['Arrokuda','water','none'],
    847: ['Barraskewda','water','none'],
    848: ['Toxel','electric','poison'],
    849: ['Toxtricity','electric','poison'],
    849: ['Toxtricity (Amped)','electric','poison'],
    849: ['Toxtricity (Low Key)','electric','poison'],
    850: ['Sizzlipede','fire','bug'],
    851: ['Centiskorch','fire','bug'],
    852: ['Clobbopus','fighting','none'],
    853: ['Grapploct','fighting','none'],
    854: ['Sinistea','ghost','none'],
    854: ['Sinistea (Antique)','ghost','none'],
    854: ['Sinistea (Phony)','ghost','none'],
    855: ['Polteageist','ghost','none'],
    855: ['Polteageist (Antique)','ghost','none'],
    855: ['Polteageist (Phony)','ghost','none'],
    856: ['Hatenna','psychic','none'],
    857: ['Hattrem','psychic','none'],
    ...
    863: ['Perrserker','steel','none'],
    864: ['Cursola','ghost','none'],
    865: ["Sirfetch'd",'fighting','none'],
    866: ['Mr. Rime','ice','psychic'],
    867: ['Runerigus','ground','ghost'],
    868: ['Milcery','fairy','none'],
    869: ['Alcremie','fairy','none'],
    870: ['Falinks','fighting','none'],
    871: ['Pincurchin','electric','none'],
    872: ['Snom','ice','bug'],
    873: ['Frosmoth','ice','bug'],
    874: ['Stonjourner','rock','none'],
    875: ['Eiscue','ice','none'],
    875: ['Eiscue (Ice)','ice','none'],
    875: ['Eiscue (Noice)','ice','none'],
    ...
    877: ['Morpeko (Hangry)','electric','dark'],
    878: ['Cufant','steel','none'],
    879: ['Copperajah','steel','none'],
    ...
    888: ['Zacian (Crowned Sword)','fairy','steel'],
    888: ['Zacian (Hero)','fairy','none'],
    889: ['Zamazenta','fighting','steel'],
    889: ['Zamazenta (Crowned Shield)','fighting','steel'],
    889: ['Zamazenta (Hero)','fighting','none'],
    890: ['Eternatus','poison','dragon'],
    890: ['Eternatus (Eternamax)','poison','dragon'],
    891: ['Kubfu','fighting','none'],
    892: ['Urshifu','fighting','none'],
    892: ['Urshifu (Rapid Strike)','fighting','water'],
    892: ['Urshifu (Single Strike)','fighting','dark'],
    893: ['Zarude','dark','grass'],
    894: ['Regieleki','electric','none'],
    895: ['Regidrago','dragon','none'],
    896: ['Glastrier','ice','none'],
    897: ['Spectrier','ghost','none'],
    898: ['Calyrex','psychic','grass'],
    898: ['Calyrex (Ice Rider)','psychic','ice'],
    898: ['Calyrex (Shadow Rider)','psychic','ghost']
})
